...
- Пробел — рывок
- **I / Tab** — инвентарь
- ПКМ по шмоту — опознать; **ЛКМ шмот → ПКМ свиток** — крафт
- Двойной ЛКМ — надеть; ПКМ по слоту — снять
- После зачистки зоны — **портал** или **G**
- F1–F8 — пассивки | R — рестарт

Стартовые свитки уже в сумке. Жёлтые квадраты на земле — золото.
